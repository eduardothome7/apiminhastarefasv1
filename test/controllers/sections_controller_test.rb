...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference('Section.count') do
      post sections_url, params: { section: { token_auth: @section.token_auth, user_id: @section.user_id } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { token_auth: @section.token_auth, user_id: @section.user_id } }
